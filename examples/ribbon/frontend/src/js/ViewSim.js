...
class ViewSim extends alfrid.View {
	...
	render(textureVel, texturePos, textureExtra) {
		...
		this.shader.uniform("minRadius", "float", params.minRadius);
		this.shader.uniform("maxRadius", "float", params.maxRadius);
		this.shader.uniform("rotationSpeed", "float", params.rotationSpeed);
		this.shader.uniform("noiseSpeed", "float", params.noiseSpeed);
		textureVel.bind(0);
		texturePos.bind(1);
		textureExtra.bind(2);
